---
title: Select
description: A flexible dropdown select component for choosing from a list of options
---
...
A customizable select (dropdown) component built with Radix UI primitives.
